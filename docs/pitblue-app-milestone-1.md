# pitblue-app Milestone 1 acceptance
...
- Platform-neutral FastAPI service using only pitblu-core REST and SSE through a
  ...
  blower dependency exists in pitblue-app.
...
Run the complete repeatable gate from `pitblue-app`:
...
[the pitblue-app README](../pitblue-app/README.md). Do not expose the application or
