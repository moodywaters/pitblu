# ADR 0005: pitblue-app platform and service boundaries
...
`pitblue-app` owns cooks, semantic measurements, time-bound assignments, history,
...
lifecycle stay outside pitblu-core, pitblue-app and browser code. A concrete blower
...
All meaningful behavior is exposed through pitblue-app's versioned backend API.
